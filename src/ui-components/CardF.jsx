      ...
      >
        ...
        >
          <Badge
            ...
            variation="default"
            children="New"
            {...getOverrideProps(overrides, "Badgerwh")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Classic"
            {...getOverrideProps(overrides, "Badgeckh")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Modern"
            {...getOverrideProps(overrides, "Badgewwy")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurecge")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconmsm")}
            >
              <Icon
                width="17.58984375px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorcku")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featuredyf")}
          >
            <View
              width="24px"
              height="24px"
            ...
            >
              <Icon
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectormme")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurekhk")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconjug")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorngh")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
