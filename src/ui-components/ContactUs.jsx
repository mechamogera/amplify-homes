  ...
  return (
    ...
    >
      ...
      <SelectField
        ...
        labelHidden={false}
        variation="default"
        {...getOverrideProps(overrides, "SelectFieldkuv")}
      ></SelectField>
      <TextField
        display="flex"
        gap="12px"
        ...
        labelHidden={false}
        variation="default"
        {...getOverrideProps(overrides, "TextFielddud")}
      ></TextField>
      <SelectField
        display="flex"
        gap="12px"
        ...
        labelHidden={false}
        variation="default"
        {...getOverrideProps(overrides, "SelectFieldtdn")}
      ></SelectField>
      <TextField
        display="flex"
        gap="12px"
        ...
        labelHidden={false}
        variation="default"
        {...getOverrideProps(overrides, "TextFieldyog")}
      ></TextField>
      <TextField
        display="flex"
        gap="12px"
        ...
        labelHidden={false}
        variation="default"
        {...getOverrideProps(overrides, "TextFieldbfk")}
      ></TextField>
      <Button
        display="flex"
        gap="0"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 28npa")}
        >
          <View
            width="24px"
            height="24px"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Icongku")}
          >
            <Icon
              width="20px"
              height="20px"
              ...
              left="8.33%"
              right="8.33%"
              {...getOverrideProps(overrides, "Vectormeu")}
            ></Icon>
          </View>
          <Text
            fontFamily="Inter"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconjgd")}
          >
            <Icon
              width="15px"
              height="17px"
              ...
              left="20.83%"
              right="16.67%"
              {...getOverrideProps(overrides, "Vectoraux")}
            ></Icon>
          </View>
          <Text
            fontFamily="Inter"
