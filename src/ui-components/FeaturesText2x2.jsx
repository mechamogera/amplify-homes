        ...
        >
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136fox")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconfdb")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorkpj")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.wkq"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376wuv")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconwpd")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorxwq")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.ncy"
                )}
              ></Text>
            </Flex>
          </Flex>
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136snw")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Icongmv")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectoryny")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.ihj"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376frs")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconajf")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectordiv")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.pbm"
                )}
              ></Text>
            </Flex>
          </Flex>
