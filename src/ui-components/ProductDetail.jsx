      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7eal")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerome")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7dlg")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerchh")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7fsc")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28dqv")}
          >
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonfep")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttoniih")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttoneor")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonhbx")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28jzd")}
          >
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonfav")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonpve")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonqsb")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttongyc")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
