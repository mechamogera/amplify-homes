    ...
    >
      ...
      >
        <Flex
          ...
          {...getOverrideProps(overrides, "Frame 321owq")}
        >
          <View
            height="80px"
            shrink="0"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "ORGANIZATIONaqr")}
            ></Text>
            <Flex
              gap="16px"
              direction="row"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 321orz")}
            >
              <View
                width="24px"
                height="24px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconuls")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectorvli")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
            ...
            >
              <View
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconrda")}
              >
                <Icon
                  width="20px"
                  height="17px"
                  ...
                  left="8.33%"
                  right="8.33%"
                  {...getOverrideProps(overrides, "Vectorsus")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
                ...
                whiteSpace="pre-wrap"
                children="Lorem Ipsum"
                {...getOverrideProps(overrides, "Lorem Ipsumgwt")}
              ></Text>
            </Flex>
          </Flex>
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 321kfn")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="ORGANIZATION"
              {...getOverrideProps(overrides, "ORGANIZATIONhep")}
            ></Text>
            <Flex
              gap="16px"
              direction="column"
            ...
            >
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconfxr")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectornfj")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumsyq")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconsny")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorbpi")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumfby")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Icongkm")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectoryjh")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumzuh")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconrgx")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorolb")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvpa")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconsff")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorqfc")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumtor")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconuiy")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorzjf")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumdni")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconizk")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorksj")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumgcw")}
                ></Text>
              </Flex>
              <Flex
                gap="16px"
              ...
              >
                <View
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "Iconliu")}
                >
                  <Icon
                    width="20px"
                    height="17px"
                    ...
                    left="8.33%"
                    right="8.33%"
                    {...getOverrideProps(overrides, "Vectorgcb")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Inter"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumvcg")}
                ></Text>
              </Flex>
            </Flex>
          </Flex>
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 321vvu")}
        >
          <Divider
            width="385px"
            height="1px"
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Frame 321mdt")}
              >
                <Text
                  fontFamily="Inter"
                  fontSize="16px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumeon")}
                ></Text>
                <Text
                  fontFamily="Inter"
                  fontSize="14px"
                  ...
                  whiteSpace="pre-wrap"
                  children="Lorem Ipsum"
                  {...getOverrideProps(overrides, "Lorem Ipsumfqe")}
                ></Text>
              </Flex>
            </Flex>
            <View
