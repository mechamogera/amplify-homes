    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              ...
              padding="0px 0px 0px 0px"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconfmf")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          >
            <Text
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharevxz")}
            ></Text>
            <MyIcon
              width="24px"
              height="24px"
              ...
              {...getOverrideProps(overrides, "MyIconwmz")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="share"
              {...getOverrideProps(overrides, "MyIconyna")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIconcta")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      >
        <MyIcon
          ...
          padding="0px 0px 0px 0px"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIconzpw")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moremgo")}
        ></Text>
      </Flex>
    </Flex>
  );
